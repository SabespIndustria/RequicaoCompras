...
function getLocalizedDateTime( date ) {
    ...
    if (isAndroid()) {
        ...
        xmlHttpReq.open("GET", "http://localhost/sup.amp?querytype=tz&version=2.1.3&command=tzdatetime&time=" + dMilliseconds, false);
        xmlHttpReq.send("");
...
function getLocalizedDate( date ) {
    ...
    if (isAndroid()) {
        ...
        var dMilliseconds = Date.UTC(date.getFullYear(), date.getMonth(), date.getDate(), 12, 0, 0 );
        var xmlHttpReq = getXMLHTTPRequest();
        xmlHttpReq.open("GET", "http://localhost/sup.amp?querytype=tz&version=2.1.3&command=tzdate&time=" + dMilliseconds, false);
        xmlHttpReq.send("");
        return (xmlHttpReq.responseText);
    }
    else if (isBlackBerry()){
...
function getLocalizedTime( date ) {
    ...
    if (isAndroid()) {
        ...
        var dMilliseconds = Date.UTC(date.getFullYear(), date.getMonth(), date.getDate(), date.getHours(), date.getMinutes(), date.getSeconds() );
        var xmlHttpReq = getXMLHTTPRequest();
        xmlHttpReq.open("GET", "http://localhost/sup.amp?querytype=tz&version=2.1.3&command=tztime&time=" + dMilliseconds, false);
        xmlHttpReq.send("");
        return (xmlHttpReq.responseText);
    }
    else if (isBlackBerry()){
...
function getOffsetFromUTC( date )
{
    ...
    else if (isWindowsMobile()) 
    {
        ...
        var lMilliseconds = date.getTime();
        var xmlHttpReq = getXMLHTTPRequest();
        xmlHttpReq.open("GET", "http://localhost/sup.amp?querytype=tz&version=2.1.3&command=utcoffset&time=" + lMilliseconds, false);
        xmlHttpReq.send("");
...
function isDstActiveAtGivenTime( date )
{
    ...
    else if (isWindowsMobile()) 
    {
        ...
        var lMilliseconds = date.getTime();
        var xmlHttpReq = getXMLHTTPRequest();
        xmlHttpReq.open("GET", "http://localhost/sup.amp?querytype=tz&version=2.1.3&command=indst&time=" + lMilliseconds, false);
        xmlHttpReq.send("");
...
function getDstOffsetAtGivenTimeInMinutes( date )
{
    ...
    else if (isWindowsMobile()) 
    {
        ...
        var lMilliseconds = date.getTime();
        var xmlHttpReq = getXMLHTTPRequest();
        xmlHttpReq.open("GET", "http://localhost/sup.amp?querytype=tz&version=2.1.3&command=dstoffset&time=" + lMilliseconds, false);
        xmlHttpReq.send("");
        return parseInt(xmlHttpReq.responseText);
    }
    else {
...
function getTimezoneId() {
    ...
    else if (isWindowsMobile()) 
    {
        ...
        var xmlHttpReq = getXMLHTTPRequest();
        xmlHttpReq.open("GET", "http://localhost/sup.amp?querytype=tz&version=2.1.3&command=tzid", false);
        xmlHttpReq.send("");
        return (xmlHttpReq.responseText);
    }
    else if (isBlackBerry()){
...
function getUsesDST() {
    ...
    else if (isWindowsMobile()) 
    {
        ...
        var xmlHttpReq = getXMLHTTPRequest();
        xmlHttpReq.open("GET", "http://localhost/sup.amp?querytype=tz&version=2.1.3&command=dstaware", false);
        xmlHttpReq.send("");
        return (parseBoolean(xmlHttpReq.responseText));
    }
    else if (isBlackBerry()){
